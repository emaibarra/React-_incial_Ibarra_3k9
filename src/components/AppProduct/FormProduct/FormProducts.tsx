...
export const FormProducts :FC<IpropsFormProduct> = ({handleAddProduct}) => {
  ...
  return (
    <Form className='p-4 border orunded m-3'>
        ...
        <Form.Control type='text' name='precio' placeholder='Ingrese el precio del producto' value={values.precio} onChange={handleChange} ></Form.Control>
        </Form.Group>
